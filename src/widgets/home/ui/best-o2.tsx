...
export const BestO2 = ({ products }: BestO2Props) => {
  ...
  return (
    <div
      ...
      className={cn(
        'mt-16 grid items-center gap-8 rounded-control border-(length:--border-width-panel) border-border-glass',
        'bg-surface-glass px-8 py-12 backdrop-blur-panel lg:grid-cols-[1fr_1.2fr] lg:rounded-panel lg:px-20',
      )}
    >
      <ResponsiveImage
        ...
        className="mx-auto w-[70%] max-w-(--size-feature-media) drop-shadow-media lg:-ml-24 lg:w-full"
      />
